...
ipx::package_project -root_dir ${proj_dir}/ip_definitions/pcie2axilite_bridge -vendor xilinx.com -library user -taxonomy /UserIP -force -import_files
...
set_property  ip_repo_paths  ${proj_dir}/ip_definitions/pcie2axilite_bridge [current_project]
update_ip_catalog
...
# Add sources
add_files $hdl_dir
add_files $root_dir/ethInConverter_prj/solution1/impl/ip/hdl/verilog
add_files $root_dir/ethOutConverter_prj/solution1/impl/ip/hdl/verilog
add_files $root_dir/memcachedPipeline_prj/solution1/impl/ip/hdl/verilog
add_files $root_dir/networkExtractor_prj/solution1/impl/ip/hdl/verilog
add_files $root_dir/networkComposer_prj/solution1/impl/ip/hdl/verilog
...
set_property top mcdDsBinPCIe_top [current_fileset]
